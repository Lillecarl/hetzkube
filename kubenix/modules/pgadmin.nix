          ...
          OAUTH2_CONFIG = [
              {
                  ...
                  'OAUTH2_TOKEN_URL': 'https://${lib.head config.keycloak.hostnames}/realms/auth/protocol/openid-connect/token',
                  'OAUTH2_AUTHORIZATION_URL': 'https://${lib.head config.keycloak.hostnames}/realms/auth/protocol/openid-connect/auth',
                  'OAUTH2_API_BASE_URL': 'https://${lib.head config.keycloak.hostnames}/realms/auth/protocol/openid-connect',
                  'OAUTH2_USERINFO_ENDPOINT': 'https://${lib.head config.keycloak.hostnames}/realms/auth/protocol/openid-connect/userinfo',
                  'OAUTH2_SERVER_METADATA_URL': 'https://${lib.head config.keycloak.hostnames}/realms/auth/.well-known/openid-configuration',
